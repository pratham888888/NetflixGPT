...
const VideoTitle = ({overview,title}) => {
  return (
    <div className='absolute top-0 left-0 px-28 pt-80 z-5 w-full aspect-video bg-gradient-to-r from-black text-white' ><h1 className='pb-10 font-bold text-5xl'>{title}</h1>
